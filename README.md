...
The `UsHolidays` class will calculate U.S. holidays for a given year and also find holidays in a date range.
...
The `EmailAddress`, in particular, is often highly underestimated - there's a lot going on in correct email address construction/validation.
